...
package Unicode.Names.Ipa_Extensions is
   ...
   Latin_Small_Letter_G_With_Hook          : constant Unicode_Char := 16#0260#;
   Latin_Small_Letter_Script_G             : constant Unicode_Char := 16#0261#;
   ...
   Latin_Small_Letter_L_With_Belt          : constant Unicode_Char := 16#026C#;
   Latin_Small_Letter_L_With_Retroflex_Hook :
      constant Unicode_Char := 16#026D#;
   Latin_Small_Letter_Lezh                 : constant Unicode_Char := 16#026E#;
   Latin_Small_Letter_Turned_M             : constant Unicode_Char := 16#026F#;
   Latin_Small_Letter_Turned_M_With_Long_Leg :
      constant Unicode_Char := 16#0270#;
   Latin_Small_Letter_M_With_Hook          : constant Unicode_Char := 16#0271#;
   Latin_Small_Letter_N_With_Left_Hook     : constant Unicode_Char := 16#0272#;
   ...
   Latin_Small_Letter_Turned_R             : constant Unicode_Char := 16#0279#;
   Latin_Small_Letter_Turned_R_With_Long_Leg :
      constant Unicode_Char := 16#027A#;
   Latin_Small_Letter_Turned_R_With_Hook   : constant Unicode_Char := 16#027B#;
   Latin_Small_Letter_R_With_Long_Leg      : constant Unicode_Char := 16#027C#;
   Latin_Small_Letter_R_With_Tail          : constant Unicode_Char := 16#027D#;
   Latin_Small_Letter_R_With_Fishhook      : constant Unicode_Char := 16#027E#;
   Latin_Small_Letter_Reversed_R_With_Fishhook :
      constant Unicode_Char := 16#027F#;
   Latin_Letter_Small_Capital_R            : constant Unicode_Char := 16#0280#;
   Latin_Letter_Small_Capital_Inverted_R   : constant Unicode_Char := 16#0281#;
   Latin_Small_Letter_S_With_Hook          : constant Unicode_Char := 16#0282#;
   Latin_Small_Letter_Esh                  : constant Unicode_Char := 16#0283#;
   Latin_Small_Letter_Dotless_J_With_Stroke_And_Hook :
      constant Unicode_Char := 16#0284#;
   Latin_Small_Letter_Squat_Reversed_Esh   : constant Unicode_Char := 16#0285#;
   Latin_Small_Letter_Esh_With_Curl        : constant Unicode_Char := 16#0286#;
   Latin_Small_Letter_Turned_T             : constant Unicode_Char := 16#0287#;
   ...
   Latin_Small_Letter_Turned_K             : constant Unicode_Char := 16#029E#;
   Latin_Letter_Small_Capital_L            : constant Unicode_Char := 16#029F#;
   Latin_Small_Letter_Q_With_Hook          : constant Unicode_Char := 16#02A0#;
   Latin_Letter_Glottal_Stop_With_Stroke   : constant Unicode_Char := 16#02A1#;
   Latin_Letter_Reversed_Glottal_Stop_With_Stroke :
      constant Unicode_Char := 16#02A2#;
   Latin_Small_Letter_Dz_Digraph           : constant Unicode_Char := 16#02A3#;
   Latin_Small_Letter_Dezh_Digraph         : constant Unicode_Char := 16#02A4#;
   Latin_Small_Letter_Dz_Digraph_With_Curl : constant Unicode_Char := 16#02A5#;
   Latin_Small_Letter_Ts_Digraph           : constant Unicode_Char := 16#02A6#;
   Latin_Small_Letter_Tesh_Digraph         : constant Unicode_Char := 16#02A7#;
   Latin_Small_Letter_Tc_Digraph_With_Curl : constant Unicode_Char := 16#02A8#;
   Latin_Small_Letter_Feng_Digraph         : constant Unicode_Char := 16#02A9#;
   Latin_Small_Letter_Ls_Digraph           : constant Unicode_Char := 16#02AA#;
