...
package Debug_Readers2 is
   type Debug_Reader is new Readers.Reader with private;
   ...
   procedure Element_Decl
     (Handler : in out Debug_Reader;
      ...
      Parsed_Model : Readers.Element_Model_Ptr);
...
private
   type Debug_Reader is new Readers.Reader with record
